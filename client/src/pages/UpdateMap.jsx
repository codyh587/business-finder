...
const UpdateMap = () => {
  ...
  function UpdateButton() {
    if (loading) {
      return <button className="btn btn-sm btn-secondary loading btn-disabled">Update</button>
    } else {
      return <button className="btn btn-sm btn-secondary" onClick={handleClick}>Update</button>
    }
  }
